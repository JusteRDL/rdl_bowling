...
Strings = {
    ['press_start'] = 'Appuyez ~INPUT_PICKUP~ pour obtenir la boule de bowling',
    ['next_last_select'] = '~INPUT_CELLPHONE_RIGHT~ ~INPUT_CELLPHONE_LEFT~ Changer de voie\n~INPUT_FRONTEND_ENDSCREEN_ACCEPT~ Sélectionner\n~INPUT_FRONTEND_RRIGHT~ Annuler',
    ['bowling_info'] = '~INPUT_CELLPHONE_LEFT~ ~INPUT_CELLPHONE_RIGHT~ Donner une direction\n~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ Force \n~INPUT_MOVE_LEFT_ONLY~ ~INPUT_MOVE_RIGHT_ONLY~ Changer de caméra\n~INPUT_ATTACK~ À\n~INPUT_FRONTEND_RRIGHT~ Annuler',
    ['force'] = 'Force: %s',
    ['strike'] = {'WOW! COMME UN MARTEAU !', 'INCROYABLE !!'},
    ['spare'] = {'Bowling', 'Bon jeu! Malheureusement rien.'},
    ['x_pinsdown'] = {'Bowling', 'Vous avez fait %s dans ce jeu %s'},
    ['this_occupied'] = 'Ce bowling est plein.',
    ['every_occupied'] = 'Nous sommes complètement pleins.',
    ['blip'] = 'Bowling'
}